...
#[no_mangle]
pub extern "C" fn wcg_core_text_decoder_create(decoding: *const c_char) -> *mut TextDecoder {
    if decoding.is_null() {
...
#[no_mangle]
pub extern "C" fn wcg_core_text_decoder_decode(
...
#[no_mangle]
pub extern "C" fn wcg_core_text_decoder_decode_as_cow(
    decoder: *const TextDecoder,
    data: *const u8,
    size: usize,
) -> *mut CCow {
...
#[no_mangle]
pub extern "C" fn wcg_core_text_decoder_decode_as_bytes(
    decoder: *const TextDecoder,
    data: *const u8,
    size: usize,
) -> *mut U8Buffer {
...
#[no_mangle]
pub extern "C" fn wcg_core_text_decoder_destroy(value: *mut TextDecoder) {
    if value.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_text_decoder_get_encoding(
    decoder: *const TextDecoder,
) -> *const c_char {
