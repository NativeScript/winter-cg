...
pub struct WCGCURL(Url);

#[no_mangle]
pub extern "C" fn wcg_core_url_can_parse(value: *const c_char, base: *const c_char) -> bool {
...
#[no_mangle]
pub extern "C" fn wcg_core_url_create(value: *const c_char, base: *const c_char) -> *mut WCGCURL {
    let value = unsafe { CStr::from_ptr(value) };
    let value = value.to_string_lossy();
    ...
    // todo return error
    match url {
        Ok(url) => Box::into_raw(Box::new(WCGCURL(url))),
        Err(_) => std::ptr::null_mut(),
    }
}

#[no_mangle]
pub extern "C" fn wcg_core_url_destroy(url: *mut WCGCURL) {
    if !url.is_null() {
...
#[no_mangle]
pub extern "C" fn wcg_core_url_to_string(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
...
#[no_mangle]
pub extern "C" fn wcg_core_url_hash(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_hash(url: *mut WCGCURL, hash: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_host(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_host(url: *mut WCGCURL, host: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_host_name(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_host_name(url: *mut WCGCURL, hostname: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_href(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_href(url: *mut WCGCURL, href: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_origin(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_password(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_password(url: *mut WCGCURL, password: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_pathname(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_pathname(url: *mut WCGCURL, pathname: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_port(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_port(url: *mut WCGCURL, port: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_protocol(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_protocol(url: *mut WCGCURL, protocol: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_search(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_search(url: *mut WCGCURL, search: *const c_char) {
    if url.is_null() {
        return;
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_username(url: *mut WCGCURL) -> *const c_char {
    if url.is_null() {
        return std::ptr::null();
    }
...
#[no_mangle]
pub extern "C" fn wcg_core_url_set_username(url: *mut WCGCURL, username: *const c_char) {
    if url.is_null() {
        return;
    }
