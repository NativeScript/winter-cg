...
#[no_mangle]
pub extern "C" fn wcg_core_text_encoder_create(encoding: *const c_char) -> *mut TextEncoder {
    if encoding.is_null() {
...
#[no_mangle]
pub extern "C" fn wcg_core_text_encoder_encode(
...
#[no_mangle]
pub extern "C" fn wcg_core_text_encoder_get_encoding(
    encoder: *const TextEncoder,
) -> *const c_char {
    if encoder.is_null() {
        return std::ptr::null();
...
#[no_mangle]
pub extern "C" fn wcg_core_text_encoder_destroy(value: *mut TextEncoder) {
    if value.is_null() {
        return;
    }
